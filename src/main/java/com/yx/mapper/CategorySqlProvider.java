...
import com.yx.model.CategoryExample.Criteria;
import com.yx.model.CategoryExample.Criterion;
...
public class CategorySqlProvider {
    ...
    public String insertSelective(Category record) {
        ...
        if (record.getCateDesc() != null) {
            VALUES("cate_desc", "#{cateDesc,jdbcType=LONGVARCHAR}");
        }
        
        return SQL();
    }

    public String selectByExampleWithBLOBs(CategoryExample example) {
        BEGIN();
        if (example != null && example.isDistinct()) {
            SELECT_DISTINCT("cate_id");
        } else {
            SELECT("cate_id");
        }
        SELECT("cate_name");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getCateDesc() != null) {
            SET("cate_desc = #{record.cateDesc,jdbcType=LONGVARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Category record) {
        ...
        if (record.getCateDesc() != null) {
            SET("cate_desc = #{cateDesc,jdbcType=LONGVARCHAR}");
        }
